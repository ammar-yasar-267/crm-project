      ...
      <Container>
        <div className="flex flex-col md:flex-row justify-between">
          <div className="mb-6 md:mb-0">
            <h3 className="font-bold text-lg mb-2">BAAM CRM Simulator</h3>
            <p className="text-sm text-muted-foreground max-w-sm">
              Professional training tool for customer service representatives. 
              Improve your skills through realistic simulations and detailed feedback.
            </p>
          </div>
        ...
        <div className="mt-8 pt-6 border-t border-border flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-muted-foreground">
            &copy; {new Date().getFullYear()} BAAM. All rights reserved.
          </p>
